 ...
 * selections.
 */
public class ReceiverListActivity extends FragmentActivity implements ReceiverListFragment.Callbacks {
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      if(findViewById(R.id.receiver_detail_container) != null) {
         ...
         ((ReceiverListFragment)getSupportFragmentManager().findFragmentById(R.id.receiver_list)).setActivateOnItemClick(true);
      }
